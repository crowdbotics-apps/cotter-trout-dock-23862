"""cotter_trout_dock_23862 URL Configuration
...
admin.site.site_header = "Cotter Trout Dock"
admin.site.site_title = "Cotter Trout Dock Admin Portal"
admin.site.index_title = "Cotter Trout Dock Admin"

# swagger
api_info = openapi.Info(
    title="Cotter Trout Dock API",
    default_version="v1",
    description="API documentation for Cotter Trout Dock App",
)
